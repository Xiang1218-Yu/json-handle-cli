...
--- FAIL: TestCloseCompletesArray (0.00s)
    bug_004_close_test.go:16: unexpected end of JSON input
FAIL
FAIL	json-handle-cli/internal/jsonstream	0.037s
--- FAIL: TestTransformFinalizesOutput (0.01s)
    bug_004_transform_test.go:13: unexpected end of JSON input
--- FAIL: TestFilterTransformMergeAndStatsWorkflow (0.00s)
    processor_test.go:77: unexpected end of JSON input
FAIL
FAIL	json-handle-cli/internal/processor	0.042s
FAIL
```

## 期望行为
数组格式的转换和输出文件应以完整、可解析的 JSON 收尾。

...
--- FAIL: TestMalformedJSONLineReturnsError (0.01s)
    bug_003_error_test.go:14: expected malformed line error
FAIL
FAIL	json-handle-cli/internal/jsonstream	0.032s
--- FAIL: TestInvalidNumericValueDoesNotMatchThreshold (0.01s)
    bug_003_numeric_test.go:17: kept=2
FAIL
FAIL	json-handle-cli/internal/processor	0.035s
FAIL
```

## 期望行为
损坏输入与非法数值应被明确报告，不能被静默吞掉。
